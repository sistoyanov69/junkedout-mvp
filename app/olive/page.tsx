...
const ACCENT = {
  name: 'olive',
  // Olive / маслено зелено palette (intentionally muted, not neon)
  text: 'text-lime-300',
  textStrong: 'text-lime-200',
...
export default function OliveHome() {
  return (
    <main className="min-h-screen bg-black text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-white/60">
                Evidence-first hiring transparency (Olive)
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 py-14 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.03)]">
          ...
          <div className={['mt-5 text-xs', ACCENT.text].join(' ')}>
            Olive accents = highlights only. Core UI stays neutral.
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-6">
          <div className="text-sm text-white/70">
            Next: embed “Recent submissions” here as a live section.
          </div>
        </div>
      </section>
    </main>
