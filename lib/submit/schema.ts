...
export const SubmitSchema = z
  .object({
    ...
    consent_no_pii: z.boolean().refine((v) => v === true, {
      message: 'You must confirm you did not include personal data in the narrative.',
    }),
    ...
    employer_identifier_type: z.enum(['VAT', 'REG_NUMBER', 'LEI', 'DUNS', 'OTHER']).optional(),
    employer_identifier_value: z.string().trim().min(2).max(64).optional(),
    ...
    contract: z
      .enum(['PERMANENT', 'TEMPORARY', 'FREELANCE', 'INTERNSHIP', 'UNKNOWN'])
      .optional()
      .default('UNKNOWN'),
    ...
    source: z
      .enum(['COMPANY_WEBSITE', 'LINKEDIN', 'RECRUITER', 'JOB_BOARD', 'REFERRAL', 'OTHER'])
      .optional()
      .default('OTHER'),
    ...
    outcome: z
      .enum(['REJECTED', 'GHOSTED', 'WITHDRAWN_BY_CANDIDATE', 'OTHER'])
      .optional()
      .default('REJECTED'),
